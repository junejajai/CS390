...
public class Crawler implements Runnable {
    ...
    public void createDB() throws SQLException, IOException {
        ...
        // Create the table
        try {
            stat.executeUpdate("CREATE TABLE URLS2 (urlid INT auto_increment, url VARCHAR(512), description VARCHAR(200), imgUrl VARCHAR(300), title VARCHAR(500), primary key (urlid))");
            stat.executeUpdate("CREATE TABLE WORDTABLE2 (word VARCHAR(300), urlId INTEGER)");
    ...
    public synchronized void insertURLInDB(String url, String descr,String img, String title) throws SQLException, IOException {
        Statement stat = connection.createStatement();
       // query = "INSERT INTO urls2(url,description,imgUrl) VALUES ('" + url + "','" + descr + "')";
        //query = "INSERT INTO urls2(url,description,imgUrl) VALUES ('"+url+"','"+descr+"','" +img+"')";
        query = "INSERT INTO urls2(url,description,imgUrl,title) VALUES ('"+url+"','"+descr+"','" +img+"','" +title+"')";
    ...
    public synchronized void crawl() throws IOException, InterruptedException {
        ...
        try {
            ...
            insertURLInDB(oldUrl, restring,img,title);
